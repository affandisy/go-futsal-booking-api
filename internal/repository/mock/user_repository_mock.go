...
func (m *MockUserRepository) UpdateEmailVerification(ctx context.Context, id uint, isVerified bool) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateEmailVerification", ctx, id, isVerified)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateEmailVerification indicates an expected call of UpdateEmailVerification.
func (mr *MockUserRepositoryMockRecorder) UpdateEmailVerification(ctx, id, isVerified interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateEmailVerification", reflect.TypeOf((*MockUserRepository)(nil).UpdateEmailVerification), ctx, id, isVerified)
}
